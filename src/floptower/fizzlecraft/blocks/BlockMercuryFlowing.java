...
public class BlockMercuryFlowing extends BlockFluid {
	...
	public BlockMercuryFlowing(int id, Material material) {
		super(id, material);
		setHardness(100F);
		setLightOpacity(1);
	...
	public void updateTick(World par1World, int par2, int par3, int par4,
		...
		if (l > 0) {
			...
			int k1 = this.getSmallestFlowDecay(par1World, par2 - 1, par3, par4,
					b1);
			...
			if (this.blockMaterial == Material.lava && l < 8 && j1 < 8
					&& j1 > l && par5Random.nextInt(4) != 0) {
				i1 *= 4;
			}
	...
	private boolean blockBlocksFlow(World par1World, int par2, int par3,
		...
		if (l != Block.doorWood.blockID && l != Block.doorIron.blockID
